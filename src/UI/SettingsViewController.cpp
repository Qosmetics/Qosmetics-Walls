...
namespace Qosmetics::Walls
{
    ...
    void SettingsViewController::DidActivate(bool firstActivation, bool addedToHierarchy, bool screenSystemEnabling)
    {
        ...
        if (firstActivation)
        {
            ...
            Qosmetics::Core::UIUtils::AddHeader(get_transform(), localization->get("QosmeticsDodgers:Settings:Settings"), Sombrero::FastColor::red());
            ...
            TOGGLE(forceFakeGlowOff, "QosmeticsDodgers:Settings:FakeGlowOff");
            TOGGLE(forceCoreOff, "QosmeticsDodgers:Settings:CoreOff");
            TOGGLE(forceFrameOff, "QosmeticsDodgers:Settings:FrameOff");
            TOGGLE(disableReflections, "QosmeticsDodgers:Settings:DisableReflections");
        }
